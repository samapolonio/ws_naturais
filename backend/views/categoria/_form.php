...
<div class="categoria-form">
    ...
    <?= $form->field($model, 'icone')->textInput(['maxlength' => 100]) ?>

    <?= $form->field($model, 'limite_inferior')->textInput(['maxlength' => 10]) ?>

    <?= $form->field($model, 'limite_superior')->textInput(['maxlength' => 10]) ?>
